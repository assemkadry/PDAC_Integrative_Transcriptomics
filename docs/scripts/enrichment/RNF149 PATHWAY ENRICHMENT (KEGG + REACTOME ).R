...
## 2 ── Load DEG file ----
file_path <- "D:/Downloads/RNF149_Associated_DEGs_Annotated.csv"
deg <- fread(file_path)
...
fwrite(as.data.table(gsea_kegg),  "GSEA_RNF149_KEGG_results.csv")
fwrite(as.data.table(gsea_react), "GSEA_RNF149_Reactome_results.csv")
